...
interface TransactionDao {
    ...
    @Query("UPDATE transaction_table SET targetName= :targetName, amount= :amount WHERE targetId=:id")
    suspend fun editTransactionById(id:Int,targetName:String, amount:Int)
